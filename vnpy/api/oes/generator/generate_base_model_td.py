...
class Generator:
    ...
    def run(self):
        ...
        self.f_sub = open(f"{self.prefix}_substruct_base_model_td.py", "w")
        ...
        self.f_cpp = open(self.filename, "r", encoding="UTF-8")
        for line in self.f_cpp:
            self.process_line_special(line)
        ...
        self.f_struct.write("}\n")
        self.f_struct.close()
        self.process_temp_extra()
        self.f_sub.close()

        self.generate_struct()

        print("base_model 解析完毕")
    ...
    def process_temp_extra(self):
        line_1 = "__OES_ORD_REQ_LATENCY_FIELDS = __OES_ORD_REQ_LATENCY_FIELDS_IMPL\n"
        line_2 = "__OES_ORD_CNFM_LATENCY_FIELDS = __OES_ORD_CNFM_LATENCY_FIELDS_IMPL\n"
        line_5 = "__OES_TRD_CNFM_LATENCY_FIELDS = __OES_TRD_BASE_LATENCY_FIELDS\n"

        self.f_sub.write(line_1)
        self.f_sub.write(line_2)
        self.f_sub.write(line_5)
